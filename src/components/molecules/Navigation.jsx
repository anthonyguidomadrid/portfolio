...
export const Navigation = ({logo, menuItems, cta}) => {
    ...
    return (
        <nav className={classNames("flex items-center justify-between flex-wrap p-6 fixed top-0 transition ease-in-out delay-150 w-full z-50", {'bg-slate-900 bg-opacity-80': ispageScrolled || isMenuOpen})}>
